        ...
        <div className="flex w-full flex-col gap-[13px]">
          <Link href="/" className="w-fit">
            <svg
              ...
              viewBox="0 9 100 26"
              fill="none"
              className="h-[26px] w-[100px] bg-center"
            >
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <h3 className="text-[11px] font-normal leading-[1.3] text-zinc-900">
              Dealls adalah job portal dan website cari kerja #1 di Indonesia
              dengan lowongan kerja berkualitas dari 3,500+ perusahaan terbaik.
              Dealls juga hadir dengan program mentoring gratis untuk
        ...
        <div className="flex w-full flex-row lg:w-fit">
          ...
          <div className="flex w-1/2 flex-col gap-3 pr-4 lg:w-[132px] lg:gap-6 lg:pr-0">
            ...
            <div className="flex flex-col items-start justify-start gap-2.5 lg:gap-3">
              {['/loker/industri', '/loker/lokasi', '/loker/posisi'].map(
                (link) => (
                  <Link
                    key={link}
                    href={link}
          ...
          <div className="flex w-1/2 flex-col gap-3 lg:w-[160px] lg:gap-6">
            ...
            <div className="flex flex-col items-start justify-start gap-2.5 lg:gap-3">
              {['/pasang-loker-gratis', 'https://kantorku.id/'].map((link) => (
                <Link
                  key={link}
                  href={link}
                  className="text-[11px] font-normal leading-[14.30px] text-zinc-900"
                >
                  {link.includes('kantorku') ? 'Kantorku' : 'ATS & Job Portal'}
                </Link>
              ))}
            </div>
          </div>
          ...
          <div className="flex w-1/2 flex-col gap-3 pr-4 lg:w-[300px] lg:gap-6 lg:pr-0">
            ...
            <div className="flex flex-col items-start justify-start gap-2.5 lg:gap-3">
              ...
              <div className="flex flex-row gap-2">
                {[
                  'https://www.instagram.com/dealls.jobs/',
                  'https://twitter.com/DeallsJobs/',
                  'https://www.linkedin.com/company/dealls/',
                ].map((social) => (
                  <a
                    key={social}
                    href={social}
              ...
              {['/about', 'https://dealls.com/pengembangan-karir'].map(
                (link) => (
                  <Link
                    ...
                    className="text-[11px] font-normal leading-[14.30px] text-zinc-900"
                  >
                    {link.includes('about') ? 'Cerita Kami' : 'Blog'}
                  </Link>
                ),
              )}
            </div>
